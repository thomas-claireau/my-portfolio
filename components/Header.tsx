...
export default function Header() {
  ...
  return (
    <header className="dark:bg-dark-600 bg-gray-100 flex justify-between gap-2 p-5 fixed top-0 w-full hover:shadow-[0_0_1.5rem_0_rgba(0,0,0,0.1)] transition ease-in-out duration-300 z-10">
